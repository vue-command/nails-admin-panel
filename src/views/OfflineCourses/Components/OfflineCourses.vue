<template>
  <v-card flat class="transparent">
    ...
    <v-btn v-if="isHideMoreButtonOffline" @click="getMoreOfflineCourses"
      >more</v-btn
    >
  </v-card>
</template>
...
import OfflineCoursesForm from "./OfflineCoursesForm.vue";
...
export default {
  ...
  computed: {
    isHideMoreButtonOffline() {
      return (
        this.offlineCourses.length < this.totalOfflineCourses &&
        !this.error &&
        !this.showForm
      );
    },
